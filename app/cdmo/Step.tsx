...
const Step: React.FC = () => {
  return (
    <section className='@container h-fit w-full  relative overflow-hidden py-15 lg:py-20 bg-backgroundSecondary'>
      ...
      <img src="/images/cdmo/8-step-innovation.svg" alt="8 Step" className='hidden @4xl:block @4xl:max-w-[800px] lg:max-w-[1024px] xl:max-w-[1440px] mx-auto h-auto object-contain object-center px-4 sm:px-6 lg:px-10' />
