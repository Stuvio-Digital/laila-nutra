  ...
  return (
    <section className="@container h-fit w-full py-15 lg:py-20 grid grid-cols-4 sm:grid-cols-12 gap-x-4 md:gap-x-5 lg:gap-x-7.5">
      ...
      <div className='col-span-4 sm:col-span-12 grid grid-cols-4 sm:grid-cols-12 gap-x-4 md:gap-x-5 lg:gap-x-7.5 gap-y-6 px-4 sm:px-6 lg:px-10 items-stretch'>
        <div className='aspect-380/240 sm:aspect-auto md:aspect-380/240 w-full h-fit col-span-4 sm:col-span-12 md:col-span-4 p-4 sm:p-5 lg:p-6 flex justify-between flex-col border border-borderColor'>
          <p className='text-subHeading2 [@media(min-width:1920px)]:text-subHeading1 leading-[110%] tracking-[-2%] font-medium mb-7 sm:mb-15'>COX Pathway - Fast Acting</p>
        ...
        <div className='aspect-380/240 sm:aspect-auto md:aspect-380/240 w-full h-fit col-span-4 sm:col-span-12 md:col-span-4 p-4 sm:p-5 lg:p-6 flex justify-between flex-col border border-borderColor'>
          <p className='text-subHeading2 [@media(min-width:1920px)]:text-subHeading1 leading-[110%] tracking-[-2%] font-medium mb-7 sm:mb-15'>LOX Pathway - Long Lasting</p>
          <ul className='flex flex-col gap-3 list-disc'>
        ...
        <div className='aspect-380/240 sm:aspect-auto md:aspect-380/240 w-full h-fit col-span-4 sm:col-span-12 md:col-span-4 p-4 sm:p-5 lg:p-6 flex justify-between flex-col border border-borderColor'>
          <p className='text-subHeading2 [@media(min-width:1920px)]:text-subHeading1 leading-[110%] tracking-[-2%] font-medium mb-7 sm:mb-15'>AntiOX - Preventive Protection</p>
          <ul className='flex flex-col gap-3 list-disc'>
