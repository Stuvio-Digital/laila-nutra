...
const InlineList: React.FC<inlineListProps> = ({ imgSrc, title, text, inlineListStructure, inlineListDetailsStructure, inlineListImgStructure, listLink, listLinkContent }) => {
  return (
    <li className={`${inlineListStructure ? inlineListStructure : "col-span-2"} py-5 md:py-6 border-t border-t-[#ebebeb] flex flex-col justify-between items-stretch gap-y-7.5`}>
