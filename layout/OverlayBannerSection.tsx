  ...
  return (
    <section className='@container h-fit xl:h-[90vh] bg-black/10  w-full relative overflow-hidden pt-15 lg:pt-20 flex flex-col justify-between gap-y-50 xl:gap-y-0'>
      ...
      {overlayBannerItems.length > 0 && (
        <div className='h-fit w-full grid grid-cols-4 sm:grid-cols-12 gap-x-4 md:gap-x-5 lg:gap-x-7.5 gap-y-7 px-4 sm:px-6 lg:px-10 pt-6 pb-6 sm:pb-7 lg:pb-10 bg-black/30 backdrop-blur-md'>
